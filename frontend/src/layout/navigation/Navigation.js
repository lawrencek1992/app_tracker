	...
	return (
		...
		{[false].map((expand) => (
			...
			<Container fluid>
				...
				{!loggedInUser 
					&& <Nav.Link href="/login" className="navigation" variant="light" id="login-link">Login</Nav.Link>}
				{!loggedInUser 
					&& <Nav.Link href="create-user" className="navigation" variant="light" id="create-account-link">Create Account</Nav.Link>}
				{loggedInUser 
					&& <Nav.Link href="/" onClick={() => logout()} variant="light" className="navigation" id="logout-link">Logout</Nav.Link>}
						...
						{loggedInUser
							? (
								<Nav className="justify-content-end flex-grow-1 pe-3">
									...
									<NavDropdown.Item href="/applications" id="applications-link">
										Applications
									</NavDropdown.Item>
